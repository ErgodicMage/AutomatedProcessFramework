...
public class MinimalScanandRunImpl : IScanandRunProcess
{
    ...
    public ValueTask<bool> Scan(CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<bool> DoRunAsync(CancellationToken cancellationToken = default)
    {
        try
        {
